...
class LoginAPIView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        if user.user_type == "other":
            ...
            return Response({'user_data': user_data, 'user_id':user_id, 'other_id':oth.pk, 'email':email, 'name':name, 'idproof':idproof, 'employment':employment, 'education':education, 'user_type': user.user_type})
        else:
            ...
            return Response({'user_data': user_data, 'user_id':user_id, 'teacher_id':tea.pk, 'email':email, 'name':name, 'idproof':idproof, 'employment':employment, 'college':college, 'position':position, 'user_type': user.user_type})
